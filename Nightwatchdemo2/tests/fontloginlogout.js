...
'fonts.com login' : function (client) {		
    ...
    client
		...
		.waitForElementVisible(".ajax-has-dropdown a[href='/secure/sign-in']",10000)
		...
		.waitForElementVisible("a[href='/account']", 6000)
		.click("a[href='/account']")
		.waitForElementVisible(".ajax-has-dropdown a[href='/customer/logout']", 3000)
